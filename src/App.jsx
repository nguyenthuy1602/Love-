...
function AppInner() {
  ...
  // Kiểm tra an toàn cho LoginPage/RegisterPage
  if (typeof LoginPage === "undefined" || typeof RegisterPage === "undefined") {
    console.error(
      "AuthPages components are undefined. Check exports in AuthPages.jsx",
    );
    return (
      <div>
        Lỗi: Không tìm thấy trang đăng nhập. Kiểm tra export trong AuthPages.jsx
      </div>
    );
  }
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
        <>
          ...
          {page === "match" && <MatchPage openUserProfile={openUserProfile} />}
          {page === "messages" && (
            <MessagesPage chatMatch={chatMatch} setChatMatch={setChatMatch} />
          )}
          {page === "profile" && (
            <ProfilePage viewUserId={viewProfile?.id || null} />
          )}
